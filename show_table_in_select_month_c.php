...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["month"]) && isset($_POST["year"])) {
        ...
        $sql = "SELECT `name`, `date`,`day`, `stime`, `etime`, `aamount`,`pamount`, `ramount`, `notes`, `numb` FROM center WHERE MONTH(date) = ? AND YEAR(date) = ? AND `delete`=1";
