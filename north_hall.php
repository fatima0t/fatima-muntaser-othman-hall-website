                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-primary">
                                        <a href="edit_information_n.php?updateid=<?php echo $row['id']; ?>" class="text-light">تعديل</a>
                                    </button>
                                    <button class="btn btn-primary">
                                        <a href="delete_n.php?removeid=<?php echo $row['id']; ?>" class="text-light">حذف</a>
                                    </button>
                                </td>
